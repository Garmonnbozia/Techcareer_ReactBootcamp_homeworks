...
//1) map yeni bir array getirirken for each hiçbir şey getirmez
...
const findProduct = products.filter(
  (q) => q.unitPrice > 30 && q.categoryId != 2
);
const _findProduct = products.filter((a) => a.unitsInStock == 0);
const __findProduct = products.filter((b) => b.id == 5);

console.log(findProduct);
console.log(_findProduct);
console.log(__findProduct);

//22 adet fiyatı 30dan büyük categoryId si 2 olmayan ürün var
//5 adet stokta olmayan ürün var
